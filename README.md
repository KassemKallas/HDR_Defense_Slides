...
This repository contains the slides from my Habilitation à Diriger des Recherches (HDR) defense at the University of Western Brittany (Université de Bretagne Occidentale).
...
The presentation summarizes a research journey through the evolving landscape of AI security, exploring adversarial and backdoor attacks, defense mechanisms, and intellectual property protection in deep learning models through watermarking techniques. It highlights theoretical advances, experimental frameworks, and practical implications for secure and trustworthy AI systems.
